...
public class TestComposicion {
	...
	public static void main(String[] args) {
		/*
		Persona persona1 = new Persona(1, "Luis", "Choque");
		Persona persona2 = new Persona(2, "Mateo", "Lopez");
        ...
        // Asignar tipo de cliente y realizar operaciones
        persona1.setTipoCliente('B');
        persona1.getCuenta().depositar(1500);
        persona1.getCuenta().retirar(700);

        persona2.setTipoCliente('E');
        persona2.getCuenta().depositar(3000);
        persona2.getCuenta().retirar(1200);
